...
def create_oauth2_auth_template(service_name, force):
    ...
    if '_' in service_name:
        capitalized_service_name = ''.join([word.capitalize() for word in service_name.split('_')])
    ...
    generate_auth_oauth2_context(service_name, capitalized_service_name, parent_path, force)
    generate_auth_oauth2_handler(service_name, capitalized_service_name, parent_path, force)
    generate_auth_oauth2_schema(service_name, capitalized_service_name, parent_path, force)
...
def generate_auth_oauth2_context(service_name, capitalized_service_name, parent_path, force):
...
def generate_auth_oauth2_handler(service_name, capitalized_service_name, parent_path, force):
...
def generate_auth_oauth2_schema(service_name, capitalized_service_name, parent_path, force):
