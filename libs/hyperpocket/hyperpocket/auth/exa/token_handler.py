...
class ExaTokenAuthHandler(AuthHandlerInterface):
    ...
    def prepare(self, auth_req: ExaTokenRequest, thread_id: str, profile: str,
    ...
    async def authenticate(self, auth_req: ExaTokenRequest, future_uid: str, *args, **kwargs) -> AuthContext:
    ...
    async def refresh(self, auth_req: ExaTokenRequest, context: AuthContext, *args, **kwargs) -> AuthContext:
    ...
    def make_request(self, auth_scopes: Optional[list[str]] = None, **kwargs) -> ExaTokenRequest:
