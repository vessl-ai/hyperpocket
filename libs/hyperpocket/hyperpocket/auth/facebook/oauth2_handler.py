...
from hyperpocket.auth.facebook.oauth2_schema import FacebookOAuth2Response, FacebookOAuth2Request
...
class FacebookOAuth2AuthHandler(AuthHandlerInterface):
    ...
    def prepare(self, auth_req: FacebookOAuth2Request, thread_id: str, profile: str,
    ...
    async def authenticate(self, auth_req: FacebookOAuth2Request, future_uid: str, *args, **kwargs) -> AuthContext:
    ...
    async def refresh(self, auth_req: FacebookOAuth2Request, context: AuthContext, *args, **kwargs) -> AuthContext:
    ...
    def make_request(self, auth_scopes: Optional[list[str]] = None, **kwargs) -> FacebookOAuth2Request:
