...
from hyperpocket.auth.linear.oauth2_schema import LinearOAuth2Response, LinearOAuth2Request
...
class LinearOAuth2AuthHandler(AuthHandlerInterface):
    ...
    def prepare(self, auth_req: LinearOAuth2Request, thread_id: str, profile: str,
    ...
    async def authenticate(self, auth_req: LinearOAuth2Request, future_uid: str, *args, **kwargs) -> AuthContext:
    ...
    async def refresh(self, auth_req: LinearOAuth2Request, context: AuthContext, *args, **kwargs) -> AuthContext:
    ...
    def make_request(self, auth_scopes: Optional[list[str]] = None, **kwargs) -> LinearOAuth2Request:
