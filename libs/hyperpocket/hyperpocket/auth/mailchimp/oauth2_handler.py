...
from hyperpocket.auth.mailchimp.oauth2_schema import MailchimpOAuth2Response, MailchimpOAuth2Request
...
class MailchimpOAuth2AuthHandler(AuthHandlerInterface):
    ...
    def prepare(self, auth_req: MailchimpOAuth2Request, thread_id: str, profile: str,
    ...
    async def authenticate(self, auth_req: MailchimpOAuth2Request, future_uid: str, *args, **kwargs) -> AuthContext:
    ...
    async def refresh(self, auth_req: MailchimpOAuth2Request, context: AuthContext, *args, **kwargs) -> AuthContext:
    ...
    def _make_auth_url(self, req: MailchimpOAuth2Request, redirect_uri: str, state: str):
        params = {
    ...
    def make_request(self, auth_scopes: Optional[list[str]] = None, **kwargs) -> MailchimpOAuth2Request:
