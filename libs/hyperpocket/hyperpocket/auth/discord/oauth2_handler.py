...
from hyperpocket.auth.discord.oauth2_schema import DiscordOAuth2Response, DiscordOAuth2Request
...
class DiscordOAuth2AuthHandler(AuthHandlerInterface):
    ...
    def prepare(self, auth_req: DiscordOAuth2Request, thread_id: str, profile: str,
    ...
    async def authenticate(self, auth_req: DiscordOAuth2Request, future_uid: str, *args, **kwargs) -> AuthContext:
    ...
    async def refresh(self, auth_req: DiscordOAuth2Request, context: AuthContext, *args, **kwargs) -> AuthContext:
    ...
    def make_request(self, auth_scopes: Optional[list[str]] = None, **kwargs) -> DiscordOAuth2Request:
