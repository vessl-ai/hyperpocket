...
from hyperpocket.auth.bitbucket.oauth2_schema import BitbucketOAuth2Response, BitbucketOAuth2Request
...
class BitbucketOAuth2AuthHandler(AuthHandlerInterface):
    ...
    def prepare(self, auth_req: BitbucketOAuth2Request, thread_id: str, profile: str,
    ...
    async def authenticate(self, auth_req: BitbucketOAuth2Request, future_uid: str, *args, **kwargs) -> AuthContext:
    ...
    async def refresh(self, auth_req: BitbucketOAuth2Request, context: AuthContext, *args, **kwargs) -> AuthContext:
    ...
    def make_request(self, auth_scopes: Optional[list[str]] = None, **kwargs) -> BitbucketOAuth2Request:
