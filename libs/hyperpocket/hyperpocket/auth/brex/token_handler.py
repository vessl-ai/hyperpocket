...
class BrexTokenAuthHandler(AuthHandlerInterface):
    name: str = "brex-token"
    description: str = "This handler is used to authenticate users using the Brex token."
    scoped: bool = False
    ...
    def prepare(self, auth_req: BrexTokenRequest, thread_id: str, profile: str,
    ...
    async def authenticate(self, auth_req: BrexTokenRequest, future_uid: str, *args, **kwargs) -> AuthContext:
    ...
    async def refresh(self, auth_req: BrexTokenRequest, context: AuthContext, *args, **kwargs) -> AuthContext:
    ...
    def make_request(self, auth_scopes: Optional[list[str]] = None, **kwargs) -> BrexTokenRequest:
