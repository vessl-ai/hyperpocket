...
from hyperpocket.auth.linkedin.oauth2_schema import LinkedinOAuth2Response, LinkedinOAuth2Request
...
class LinkedinOAuth2AuthHandler(AuthHandlerInterface):
    ...
    def prepare(self, auth_req: LinkedinOAuth2Request, thread_id: str, profile: str,
    ...
    async def authenticate(self, auth_req: LinkedinOAuth2Request, future_uid: str, *args, **kwargs) -> AuthContext:
    ...
    async def refresh(self, auth_req: LinkedinOAuth2Request, context: AuthContext, *args, **kwargs) -> AuthContext:
    ...
    def make_request(self, auth_scopes: Optional[list[str]] = None, **kwargs) -> LinkedinOAuth2Request:
