...
from hyperpocket.auth.microsoft_clarity.token_schema import MicrosoftClarityTokenResponse
class MicrosoftClarityTokenAuthContext(MicrosoftClarityAuthContext):
    @classmethod
    def from_microsoft_clarity_token_response(cls, response: MicrosoftClarityTokenResponse):
