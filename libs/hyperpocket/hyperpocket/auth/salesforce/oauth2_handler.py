...
from hyperpocket.auth.salesforce.oauth2_schema import SalesforceOAuth2Response, SalesforceOAuth2Request
...
class SalesforceOAuth2AuthHandler(AuthHandlerInterface):
    ...
    def prepare(self, auth_req: SalesforceOAuth2Request, thread_id: str, profile: str,
    ...
    async def authenticate(self, auth_req: SalesforceOAuth2Request, future_uid: str, *args, **kwargs) -> AuthContext:
    ...
    async def refresh(self, auth_req: SalesforceOAuth2Request, context: AuthContext, *args, **kwargs) -> AuthContext:
    ...
    def _make_auth_url(self, req: SalesforceOAuth2Request, redirect_uri: str, state: str):
        params = {
    ...
    def make_request(self, auth_scopes: Optional[list[str]] = None, **kwargs) -> SalesforceOAuth2Request:
