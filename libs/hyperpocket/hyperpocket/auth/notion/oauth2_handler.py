...
from hyperpocket.auth.notion.oauth2_schema import NotionOAuth2Response, NotionOAuth2Request
...
class NotionOAuth2AuthHandler(AuthHandlerInterface):
    ...
    def prepare(self, auth_req: NotionOAuth2Request, thread_id: str, profile: str,
    ...
    async def authenticate(self, auth_req: NotionOAuth2Request, future_uid: str, *args, **kwargs) -> AuthContext:
    ...
    async def refresh(self, auth_req: NotionOAuth2Request, context: AuthContext, *args, **kwargs) -> AuthContext:
    ...
    def make_request(self, auth_scopes: Optional[list[str]] = None, **kwargs) -> NotionOAuth2Request:
