...
class Mem0TokenAuthHandler(AuthHandlerInterface):
    name: str = "mem0-token"
    description: str = "This handler is used to authenticate users using the Mem0 token."
    scoped: bool = False
    ...
    def prepare(self, auth_req: Mem0TokenRequest, thread_id: str, profile: str,
    ...
    async def authenticate(self, auth_req: Mem0TokenRequest, future_uid: str, *args, **kwargs) -> AuthContext:
    ...
    async def refresh(self, auth_req: Mem0TokenRequest, context: AuthContext, *args, **kwargs) -> AuthContext:
    ...
    def make_request(self, auth_scopes: Optional[list[str]] = None, **kwargs) -> Mem0TokenRequest:
